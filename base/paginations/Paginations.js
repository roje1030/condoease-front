...
const Paginations = () => {
  ...
  const requests = [
    ...
    { type: 'Cleaning', category: 'Hallway / Common Area' }
  ];
    ...
    <div className="p-3 pb-5">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div className="d-flex align-items-center gap-2">
          ...
          <h5 className="fw-bold mb-0">Pending Request</h5>
        </div>

        {view === 'detail' && (
          <CButton color="link" className="text-danger p-0 m-0" onClick={handleDelete}>
            <img src="src/assets/images/Delete.svg" alt="Delete" style={{ width: '20px', height: '20px' }} />
          </CButton>
        )}
      </div>
      ...
      {view === 'detail' && (
        <CForm>
          <div className="mb-3">
            ...
            <CFormSelect style={{ borderColor: '#8FAF8B' }} defaultValue={selectedRequest?.type || 'Emergency Maintenance'}>
          ...
          <div className="mb-3">
            ...
            <CFormSelect style={{ borderColor: '#8FAF8B' }} defaultValue={selectedRequest?.category || 'Water Leaks / Flooding'}>
              <option>Water Leaks / Flooding</option>
              <option>Electrical</option>
              <option>Hallway / Common Area</option>
            </CFormSelect>
          </div>
          ...
          <div className="mb-3">
            ...
            <CButton
              ...
              className="text-white small mb-3 px-4 py-2"
              color="warning"
          ...
          <CButton
            color="warning"
            className="text-white w-100 fw-bold rounded-pill shadow mt-4"
          >
            Save changes
          </CButton>
        </CForm>
